  ...
  return (
    ...
    >
      <SectionHeader
        ...
        subtitle="Quản lý thông tin định danh và liên lạc của bạn."
      />
              ...
              >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            className="h-12 rounded-xl bg-muted/30 border-none font-medium focus-visible:ring-1 focus-visible:ring-primary/20"
                            {...field}
                          />
                        </FormControl>
                ...
                <div className="flex justify-end pt-4">
                  <Button
                    type="submit"
                    size="lg"
                    className="h-12 px-10 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary/20"
    ...
    >
      <div className="flex items-end justify-between">
        <SectionHeader
          ...
          subtitle="Quản lý các địa điểm nhận hàng của bạn."
        />
      </div>
        ...
        {addressList.length > 0 ? (
              ...
              <CardContent className="p-6 space-y-4">
                <div className="flex justify-between items-start">
                  <Badge
                    ...
                    className="rounded-md text-[8px] font-black uppercase tracking-widest px-2 py-0"
                  >
                    {addr.type}
                  </Badge>
                </div>
          ...
          <div className="col-span-full p-12 rounded-[2.5rem] bg-white dark:bg-neutral-900 border-2 border-dashed border-black/5 flex flex-col items-center text-center gap-4">
            ...
            <p className="text-sm font-medium text-muted-foreground">
              Bạn chưa thiết lập địa chỉ nào. Cập nhật trong Thông tin cá nhân.
            </p>
          </div>
        )}
      </div>
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        subtitle="Những sản phẩm bạn đang quan tâm."
      />
      ...
      {isLoading ? (
        ...
        <div className="p-12 rounded-[2.5rem] bg-white dark:bg-neutral-900 border-2 border-dashed border-black/5 flex flex-col items-center text-center gap-4">
          ...
          <Button
            asChild
            className="rounded-full font-black text-[10px] uppercase mt-2"
          >
...
function NotificationsSection() {
  const notifications = [
    {
      ...
      message:
        "Đơn hàng #123456 của bạn đang được giao. Vui lòng chú ý điện thoại.",
      time: "2 giờ trước",
      isRead: false,
    },
    {
      ...
      message: "Giảm 20% cho tất cả các sản phẩm Apple. Số lượng có hạn!",
      time: "1 ngày trước",
      isRead: true,
    },
    {
      ...
      message:
        "Hệ thống sẽ bảo trì từ 2h-4h sáng ngày mai. Mong bạn thông cảm.",
      time: "2 ngày trước",
      isRead: true,
    },
  ];
  ...
  return (
    ...
    >
      <SectionHeader
        title="Thông báo"
        subtitle="Cập nhật mới nhất về đơn hàng và ưu đãi dành cho bạn."
      />
          ...
          <div
            ...
            className={cn(
              ...
              !notif.isRead
                ...
                : "bg-white dark:bg-neutral-900 border-black/5",
            )}
          >
            <div
              className={cn(
    ...
    >
      <div className="flex items-end justify-between">
        <SectionHeader
          ...
          subtitle="Quản lý thẻ và các tài khoản thanh toán của bạn."
        />
        <Button
          size="sm"
          className="mb-8 rounded-full font-black text-[9px] uppercase tracking-widest gap-2"
        >
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-8 w-8 rounded-full hover:bg-destructive/5 text-destructive/60"
                >
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        subtitle="Bảo vệ tài khoản của bạn với các lớp bảo mật bổ sung."
      />
          ...
          <CardContent className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Bạn nên đổi mật khẩu định kỳ để bảo vệ tài khoản.
              </p>
            </div>
            <Button variant="outline" className="text-xs font-bold shrink-0">
              Cập nhật
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-neutral-900 border-black/5 dark:border-white/5 ring-1 ring-black/5 rounded-2xl">
          <CardContent className="p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Thêm một lớp bảo mật khi đăng nhập vào tài khoản của bạn.
              </p>
            </div>
      ...
      <div className="container max-w-[1280px] mx-auto px-6 py-10 md:py-16">
        ...
        <div className="mb-12 space-y-1">
          ...
          <p className="text-sm text-muted-foreground font-medium">
            Quản lý hồ sơ, đơn hàng và các tùy chọn bảo mật của bạn.
          </p>
        </div>
          ...
          <main className="lg:col-span-9">
            <AnimatePresence mode="wait">
              ...
              {activeSection === "address" && (
                <AddressesSection key="address" />
              )}
              {activeSection === "wishlist" && (
                <WishlistSection key="wishlist" />
              )}
              ...
              {activeSection === "orders" && (
                ...
                >
                  <SectionHeader
                    ...
                    subtitle="Xem lại các đơn hàng bạn đã thực hiện."
                  />
                  <div className="p-12 rounded-[2.5rem] bg-white dark:bg-neutral-900 border-2 border-dashed border-black/5 flex flex-col items-center text-center gap-4">
              ...
              {![
                ...
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="py-20 flex flex-col items-center justify-center text-center gap-4 bg-white dark:bg-neutral-900 rounded-[2rem] border ring-1 ring-black/5"
                >
                  ...
                  <p className="text-xs text-muted-foreground max-w-[240px]">
                    Chúng tôi đang nỗ lực hoàn thiện trải nghiệm tuyệt vời nhất
                    cho bạn.
                  </p>
                </motion.div>
              )}
